        ...
        .dialog_content{
            ...
            .dialog_description{
                ...
                li{
                    ...
                    height: 36px;
                    line-height: 34px;
                    font-family: GothamHTF,PingFangSC-Regular, PingFang SC,'微软雅黑',Verdana, Arial, Helvetica, sans-serif;
                    ...
                    >b{
                        font-size: 18px;
                        font-family: PingFangSC-Regular, PingFang SC,'微软雅黑',Verdana, Arial, Helvetica, sans-serif;
                        color: #FFFA00;
                    }
                }
            }
