...
<!--                <img class="pic-404__parent" src="@/assets/images/chat_empty.png" alt="404">-->
            ...
            <div class="bullshit">
                ...
                <a href="" class="bullshit__return-home" style="background: linear-gradient(233deg, #EA5EF7 0%, #776CF3 100%)">Back to home</a>
            </div>
        </div>
    </div>
</template>
