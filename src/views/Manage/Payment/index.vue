    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column prop="price" sortable label="支付金额">
          <template slot-scope="scope">
            <span v-if="scope.row.price == ''" style="color: #999999"
              >待反馈</span
            >
          ...
          <template slot-scope="scope">
            ...
            >
              <i
                ...
                style="color: #02a9f1; font-size: 20px"
              ></i
              >支付宝
            </div>
            <div
            ...
            >
              <i
                ...
                style="color: #3bca72; font-size: 20px"
              ></i
              >微信
            </div>
            <div
              v-if="scope.row.type === 'paypal'"
              style="
                display: flex;
                align-items: center;
                justify-content: center;
