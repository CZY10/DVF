      ...
      <div class="banner_img">
        <el-row style="border-radius: 20px; overflow: hidden">
          <video width="100%" height="100%" autoplay muted loop>
            <source
              src="../../assets/images/video/home_banner.mp4"
              type="video/mp4"
            />
          </video>
        </el-row>
    ...
    <div class="content">
      ...
      >
        <el-col :span="15">
          <div
            class="tabs_content"
            @mouseover="mouseover('tabPane1')"
            @mouseout="mouseout('tabPane1')"
          >
            <div
              :class="{
                tab_pane1: currentIndex == 0,
                tab_pane2: currentIndex == 1,
                tab_pane3: currentIndex == 2,
            ...
            <div
              :class="{
                tab_pane2: currentIndex == 0,
                tab_pane3: currentIndex == 1,
                tab_pane4: currentIndex == 2,
            ...
            <div
              :class="{
                tab_pane3: currentIndex == 0,
                tab_pane4: currentIndex == 1,
                tab_pane1: currentIndex == 2,
            ...
            <div
              :class="{
                tab_pane4: currentIndex == 0,
                tab_pane1: currentIndex == 1,
                tab_pane2: currentIndex == 2,
      ...
      >
        <el-col :span="9" style="max-width: 428px">
          <ul class="tabs_header1">
            <li
              v-for="(item, index) in buyerShowTabList"
              :key="index"
              @click="currentIndex1 = index"
              :class="{ active1: currentIndex1 == index }"
            >
              <div>
                <i
                  class="iconfont"
      ...
      >
        <ul class="tabs_header2 pb46">
          <li
            v-for="(item, index) in shootPlanTabList.category"
            :key="index"
        ...
        <div class="tabs_content1" @click="mouseover('tabPane3')">
          <div
            v-for="(item, index) in shootPlanTabList.items"
            :key="index"
            ...
            <el-row :gutter="30">
                ...
                <div class="video_content">
                  ...
                  <div>
                    ...
                    <el-row class="params2">
                      <el-col :span="12">
                        <p>
                          卖点展示：<span>{{ item.sellingpoint_id }}</span>
                        </p>
                        <p>
                          视频时长：<span
                            >{{ item.minvideo }}-{{ item.maxvideo }}s</span
                          >
                        </p>
                      </el-col>
                      <el-col :span="12">
                        <p>
                          拍摄场景：<span>{{ item.scene_id }}</span>
                        </p>
                        <p>
                          视频上传：<span>{{ item.videoupload_id }}</span>
                        </p>
                      </el-col>
                    </el-row>
                  </div>
              ...
              <el-col :span="8">
                <div class="video_text">
                  ...
                  <ul>
                    <li>
                      创作者：<span style="color: #fbc07a"
                        >NO.{{ item.id }}</span
                      >
                    </li>
                    <li>
                      达人类型：<span>{{ item.type }}</span>
                    </li>
                    <li>
                      性别：<span>{{
                        item.genderdata === "male" ? "男" : "女"
                      }}</span>
                    </li>
                    <li>
                      国家：<span>{{ item.country_id.name }}</span>
                    </li>
                    <li
                      style="
                        overflow: hidden;
      ...
      <h2 class="content_title pt160 pb18">我们的服务</h2>
      <p class="content_description pb40">
        以优质服务换取客户复购，是我们的最高经营战略
      </p>
      <el-row
        class="services_box"
        style="
          ...
          <el-col :span="12">
            <el-row class="services_flex">
              ...
              <el-col :span="20">
                ...
                <p class="services_description">
                  结合产品现状及竞品情况，给您提供专业的listing优化策略及视频拍摄方案
                </p>
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="12">
            <el-row class="services_flex">
              ...
              <el-col :span="20">
                ...
                <p class="services_description">
                  专业化的国内及海外服务团队进行业务沟通，无障碍、无偏差落实您的诉求
                </p>
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="12">
            <el-row class="services_flex">
              ...
              <el-col :span="20">
                ...
                <p class="services_description">
                  交付前你的服务费用会在平台进行冻结，在您验收确认后，我们才会打款给创作者
                </p>
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="12">
            <el-row class="services_flex">
              ...
              <el-col :span="20">
                ...
                <p class="services_description">
                  视频交付时平台会先审核把关，若不合格，平台会责成重拍，通过后才反馈给您进行确认
                </p>
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="12">
            <el-row class="services_flex">
              ...
              <el-col :span="20">
                ...
                <p class="services_description">
                  平台会持续跟踪您的视频效果，有任何问题您都可以向我们反馈，我们会第一时间协调处理
                </p>
              </el-col>
            </el-row>
          </el-col>
      ...
      <el-row style="text-align: center"
        ><el-button class="apply_for_shooting" @click="handleGoLogin" round
          >申请拍摄</el-button
        ></el-row
      >
        ...
        <el-row :gutter="30">
          ...
          <el-col :span="6">
            <div class="advantage_item">
              ...
              <p class="advantage_description">
                交付原创视频，二次剪辑可上传到主图视频、A+视频、QA视频等
              </p>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="advantage_item">
              ...
              <p class="advantage_description">
                专业海外服务团队对接需求，确认服务后通常7-14日即可交付
              </p>
            </div>
          </el-col>
        </el-row>
      </el-row>
      <el-row style="text-align: center" class="pb160"
        ><el-button class="apply_for_shooting" @click="handleGoLogin" round
          >申请拍摄</el-button
        ></el-row
      >
...
export default {
  ...
  data() {
    return {
      ...
      tabList: [
        {
          ...
          label: "关联视频",
          description:
            "阻止竞品关联！还可抢占竞品流量，增强买家购买信心，提升产品转化",
        },
        {
          no: "02.",
          label: "主图视频",
          description:
            "拔高产品调性！凸显产品特性和细节，有效减少客户退换货及差评",
        },
        {
          no: "03.",
          label: "A+视频",
          description:
            "提升产品说服力！更有助于提高listing转化率和复购率，减少退换货和差评",
        },
        {
          no: "04.",
          label: "QA视频",
          description:
            "增加产品可信度！提升买家购买信心和购物体验，提高listing转化和权重",
        },
      ],
      buyerShowTabList: [
        {
          label: "拥有官方认证标识",
          description:
            "Influencer帮拍开箱视频，通过其账号上传，带有Earns Commissions官认方证标志",
          icon: "icon-renzheng",
          color: "#F44EFF",
        },
        {
          label: "抢夺竞品关联流量",
          description:
            "视频会一有定概率被亚马算逊法关联到竞品页上面去，从而给产品引来更多的流量",
          icon: "icon-yuanxinglianjie_circular-connection",
          color: "#2D6CEF",
        },
        {
          label: "成为Influencer长期推荐产品",
          description:
            "视频不仅展示在产品页面videos位置，也会展示在Influencer个人主页，作为长期推荐买购的产品",
          icon: "icon-tuijian",
          color: "#00B2FF",
        },
        {
          label: "附带社媒免费传播",
          description:
            "Influencer通常会有自己的Youtube/Tiktok/Ins等社媒账号，拍完视频后会同步到社媒平台展现",
          icon: "icon-chuanbo",
          color: "#00D9AD",
        },
      ],
      serviceslist: [
        {
          title: "匹配最佳创作达人",
          description: "基于产品及您的实际需求，筛选、匹配最适合的达人为你创作",
        },
        {
          title: "专业视频拍摄方案",
          description:
  ...
  methods: {
          ...
          this.$nextTick(() => {
            if (this.shootPlanTabList.items.length > 0) {
              this.shootPlanTabList.items.forEach((item, index) => {
                videojs("my-player" + index, {}, function onPlayerReady() {
    ...
    autoPlay(tabs) {
      ...
      if (tabs == "tabPane1") {
        ...
        this.autoPlayInter3 = setInterval(function () {
          if (
            _this.currentIndex2 ==
            _this.shootPlanTabList.category.length - 1
          ) {
    ...
    mouseover(tabs) {
      if (tabs == "tabPane1") {
        clearInterval(this.autoPlayInter1);
        this.autoPlayInter1 = null;
      } else if (tabs == "tabPane2") {
        clearInterval(this.autoPlayInter2);
        this.autoPlayInter2 = null;
      } else if (tabs == "tabPane3") {
        clearInterval(this.autoPlayInter3);
        this.autoPlayInter3 = null;
      }
    },
    mouseout(tabs) {
      if (tabs == "tabPane1") {
...
.active1 {
  ...
  border-image: linear-gradient(
    180deg,
    rgba(121, 108, 243, 0.35),
    rgba(223, 96, 247, 0.35),
    rgba(251, 150, 139, 0.35)
  );
  display: flex;
  &::before {
    content: "";
...
#home {
  .banner {
    ...
    h1 {
      ...
      padding-top: 50px;
      span {
        font-family: GothamHTF, "微软雅黑", Verdana, Arial, Helvetica,
          sans-serif;
      }
    }
    .banner_img {
    ...
    .tabs_content1 {
      ...
      .video_content {
        ...
        &::after {
          ...
          height: calc(100% - 2px);
          border-radius: 20px;
          background: linear-gradient(180deg, #131648, #000827);
        }
        .params1 {
